...
# SDK installation
& { (New-Object System.Net.WebClient).DownloadFile('https://www.syncfusion.com/downloads/support/directtrac/general/ze/android-31-1914274036', 'C:/Software/android-31-1914274036.zip') }

#Extract zip file
Add-Type -AssemblyName System.IO.Compression.FileSystem
[System.IO.Compression.ZipFile]::ExtractToDirectory('C:/Software/android-31-1914274036.zip', 'C:\Program Files (x86)\Android\android-sdk\platforms')
