...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    public class StackedLineSeries : StackedSeriesBase
    {
        ...
        internal override void Animate()
        {
            ...
            animation.Begin();
            // WinUI-845023 To avoid debugger exceptions during chart maximization, we have animated data labels after data points animation has been completed.
            AnimateAdornments();
        ...
        internal override void ResetAdornmentAnimationState()
        {
            if (adornmentInfo != null)
            {
                ...
                {
                    var frameworkElement = label as FrameworkElement;
