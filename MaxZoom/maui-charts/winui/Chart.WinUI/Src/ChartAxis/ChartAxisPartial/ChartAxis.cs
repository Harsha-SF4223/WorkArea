...
namespace Syncfusion.UI.Xaml.Charts
{
	...
	public partial class ChartAxis
	{
        ...
        /// <summary>
        /// Gets the double value that represents the observable minimum value of the axis range
        /// </summary>
        internal double VisibleMinimum
        {
            get
            {
        ...
        /// <summary>
        /// Gets the double value that represents the observable maximum value of the axis range
        /// </summary>
        internal double VisibleMaximum
        {
            get
            {
