...
{
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1710: Identifiers should have correct suffix")]
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1805: Do not initialize unnecessarily")]
    internal class RectAnimation : DependencyObject
    {
        #region fields
...
#region methods
        ...
        public void Stop()
        {
            ...
            {
                timer.Stop();
                // WinUI-837121 Unhook the timer tick event method to prevent the interruption of the segment rendering process when minimizing or maximizing the window.
    ...
    internal class RectAnimationCompletedArgs : EventArgs
    {
        public object SourceObj { get; set; }
        public TimeSpan Duration { get; set; }
    }

    internal delegate void RectAnimationCompletedHandler(object sender, RectAnimationCompletedArgs e);
