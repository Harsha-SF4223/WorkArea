...
#endif
{
    public partial class DateTimeAxis : RangeAxisBase
    {
        ...
        internal override void GenerateVisibleLabels()
        {
            ...
            if (this != null)
            {
                isOverriddenOnCreateLabelsMethod = ChartUtils.IsOverriddenMethod(this, "OnCreateLabels");
            }

            var actualLabels = VisibleLabels;
            var format = LabelStyle != null ? LabelStyle.LabelFormat : String.Empty;
            var labelFormat = !string.IsNullOrEmpty(format) ? format : GetSpecificFormatedLabel(ActualIntervalType);
        ...
        private void UpdateDefaultMinimum(DateTime? dateTime)
        {
            this.DefaultMinimum = dateTime;
        }
        ...
        private void UpdateDefaultMaximum(DateTime? dateTime)
        {
            this.DefaultMaximum = dateTime;
        }
        ...
        private void UpdateActualIntervalType(DateTimeIntervalType intervalType)
        {
            this.ActualIntervalType = intervalType;
        }
