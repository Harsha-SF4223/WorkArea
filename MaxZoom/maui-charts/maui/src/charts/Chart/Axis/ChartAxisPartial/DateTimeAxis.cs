...
namespace Syncfusion.Maui.Charts
{
    ...
    public partial class DateTimeAxis
    {
        ...
        private static void OnPlotBandsValueChanged(BindableObject bindable, object oldValue, object newValue)
        {
        ...
        private void OnPlotBandPropertyChanged(DateTimePlotBandCollection? oldValue, DateTimePlotBandCollection? newValue)
        {
            if (oldValue != null)
            {
