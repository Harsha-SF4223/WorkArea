...
namespace Syncfusion.Maui.Charts
{
    ...
    public partial class LogarithmicAxis
    {
        ...
        /// </summary>
        public static readonly BindableProperty PlotBandsProperty = BindableProperty.Create(nameof(PlotBands), typeof(NumericalPlotBandCollection), typeof(LogarithmicAxis), null, BindingMode.Default, null, OnPlotBandsPropertyChanged);
