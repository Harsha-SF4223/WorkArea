...
namespace Syncfusion.Maui.Charts
{
	...
	internal Brush MajorGridLineStroke
        ...
        internal virtual double ValueToPolarCoefficient(double value)
        {
            ...
            {
                result *= 1 - (1 / (double)VisibleLabels.Count);
            }
            else
            {
                result *= 1 - (1 / (delta + 1));
        ...
        {
            if (cartesianArea != null && cartesianArea.PlotArea is CartesianPlotArea plotarea)
            {
        ...
        {
            e.ApplyCollectionChanges((index, plotBand) => AddPlotBand(index, plotBand), (index, plotBand) => RemovePlotBand(index, plotBand), ResetPlotBand);
            InvalidatePlotBands();
        }
        ...
        protected override void OnParentSet()
        {
            ...
            if (LabelStyle != null)
            {
                LabelStyle.Parent = this.Parent;
            }

            if (MajorGridLineStyle != null)
            {
                MajorGridLineStyle.Parent = this.Parent;
            }

            if (AxisLineStyle != null)
            {
                AxisLineStyle.Parent = this.Parent;
            }

            if (MajorTickStyle != null)
            {
                MajorTickStyle.Parent = this.Parent;
            }

            if (Title != null)
            {
                Title.Parent = this.Parent;
            }

            if (TrackballLabelStyle != null)
            {
                TrackballLabelStyle.Parent = this.Parent;
            }
        ...
        private static void OnLabelStyleChanged(BindableObject bindable, object oldValue, object newValue)
        {
            if (bindable is ChartAxis axis)
            {
                if (oldValue != null)
                {
                    if (oldValue is ChartAxisLabelStyle style)
                    {
                        style.PropertyChanged -= axis.Style_PropertyChanged;
                    }
                }
        ...
        private static void OnTrackballLabelStyleChanged(BindableObject bindable, object oldValue, object newValue)
        {
            if (bindable is ChartAxis axis)
            {
                if (newValue != null)
                {
                    ...
                    {
                        SetInheritedBindingContext(style, axis.BindingContext);
                        axis.InitializeTrackballAxisDynamicResource(style);
                    }
                }
        ...
        internal void InitializeTrackballAxisDynamicResource(ChartLabelStyle style)
        {
        ...
        private void InitializeConstructor()
        {
            ...
            this.SetDynamicResource(TrackballAxisBackgroundProperty, "SfCartesianChartTrackballAxisLabelBackground");
            this.SetDynamicResource(TrackballAxisFontSizeProperty, "SfCartesianChartTrackballAxisLabelTextFontSize");
            this.SetDynamicResource(MajorGridLineStrokeProperty, "SfCartesianChartMajorGridLineStroke");
        ...
        private void OnPlotBandsPropertyChanged(NumericalPlotBandCollection? oldValue, NumericalPlotBandCollection? newValue)
        {
            if (oldValue != null)
            {
        ...
        private void ResetPlotBand()
        {
            ActualPlotBands.Clear();
        }

        private void RemovePlotBand(int index, object item)
        {
            var plotBand = (ChartPlotBand)item;
            if (plotBand != null)
            {
        ...
        private void AddPlotBand(int index, object item)
        {
            var plotBand = (ChartPlotBand)item;
            if (plotBand != null)
            {
