...
namespace Syncfusion.Maui.Charts
{
    ...
    public partial class RangeAxisBase
    {
        ...
        public RangeAxisBase()
        {
            ...
            this.SetDynamicResource(MinorGridLineStrokeProperty, "SfCartesianChartMinorGridLineStroke");
            MinorGridLineStyle = new ChartLineStyle() { Stroke = MinorGridLineStroke };
