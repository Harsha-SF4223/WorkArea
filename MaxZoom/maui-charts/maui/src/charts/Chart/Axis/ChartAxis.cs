...
#endif
{
...
#endif
    {
...
#else
        //todo: Used for code sharing conflict. 
        internal bool IsPolarArea = false;
#endif
        internal double ActualAutoScrollDelta { get; set; } = double.NaN;
        internal bool CanAutoScroll { get; set; } = false;
        internal bool isOverriddenOnCreateLabelsMethod = false;
...
#if WinUI
        DoubleRange actualDoubleRange = DoubleRange.Empty;
        internal DoubleRange VisibleRange
        {
            get
            {
                return actualDoubleRange;
            }
            set
            {
                DoubleRange oldRange = actualDoubleRange;
                actualDoubleRange = value;
                OnAxisVisibleRangeChanged(new VisibleRangeChangedEventArgs() { OldRange = oldRange, NewRange = value });
            }
        }
#else
        DoubleRange actualRange = DoubleRange.Empty;
        ...
        public ChartAxis()
        {
            ...
            ActualPlotBands = new ObservableCollection<ChartPlotBand>();
#endif
        ...
        {
            return IsPolarArea ? PolarArea?.VisibleSeries : cartesianArea?.VisibleSeries;
#else
        internal ChartVisibleSeriesCollection GetVisibleSeries()
        {
            return cartesianArea?.VisibleSeries;
#endif
        }
...
#if WinUI
        internal virtual void OnAxisVisibleRangeChanged(VisibleRangeChangedEventArgs args)
        {
        ...
        private void InvokeLabelCreated(ChartAxisLabel item)
        {
            ...
            if (LabelCreated != null)
            {
                ...
                {
#if !WinUI
                    args.LabelStyle.Parent = this.Parent;
#endif
