...
namespace Syncfusion.Maui.Charts
{
    ...
    /// ***
    /// </remarks>
    public class SfPyramidChart : ChartBase, IPyramidChartDependent, IDrawCustomLegendIcon, ITapGestureListener, ITouchListener, IParentThemeElement
    {
        #region Fields
        ...
        /// </summary>        
        public static readonly BindableProperty LabelTemplateProperty = BindableProperty.Create(nameof(LabelTemplate), typeof(DataTemplate), typeof(SfPyramidChart), null, BindingMode.Default, null, null);
        ...
        void IPyramidChartDependent.UpdateLegendItemsSource(ObservableCollection<ILegendItem> legendItems)
        {
            ...
            for (int i = 0; i < this.pointsCount; i++)
            {
                ...
                chartArea.UpdateLegendItem(legendItem);
        ...
        private void InitiateDataLabel(PyramidSegment pyramidSegment)
        {
