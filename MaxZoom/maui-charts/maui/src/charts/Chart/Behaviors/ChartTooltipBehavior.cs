...
namespace Syncfusion.Maui.Charts
{
    ...
    public class ChartTooltipBehavior : ChartBehavior , IParentThemeElement
    {
        ...
        public static readonly BindableProperty BackgroundProperty =
            BindableProperty.Create(nameof(Background), typeof(Brush), typeof(ChartTooltipBehavior), null, BindingMode.Default, null, defaultValueCreator: BackgroundDefaultValueCreator);
        ...
        public static readonly BindableProperty TextColorProperty =
            BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(ChartTooltipBehavior), null, BindingMode.Default, null, defaultValueCreator: TextColorDefaultValueCreator);
