...
namespace Syncfusion.Maui.Charts
{
    ...
    public abstract class ChartSelectionBehavior : ChartBehavior , IParentThemeElement
    {
        ...
        internal void InitializeDynamicResource(ChartSelectionBehavior behavior)
        {
            ...
            {
                this.SetDynamicResource(SelectionBrushProperty, "SfChartDataPointSelectionBrush");
            }
            else
            {
                this.SetDynamicResource(SelectionBrushProperty, "SfChartSeriesSelectionBrush");
            }
        }
        ...
        internal bool IsUpdateOnTap { get; set; }
        ...
        {
            if (bindable is ChartSelectionBehavior behavior && behavior.Type != ChartSelectionType.None && !behavior.IsUpdateOnTap)
            {
                if (oldValue != null)
                {
