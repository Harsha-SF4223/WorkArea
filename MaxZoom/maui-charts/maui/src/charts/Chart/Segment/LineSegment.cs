...
namespace Syncfusion.Maui.Charts
{
    ...
    /// </summary>
    public partial class LineSegment : CartesianSegment, IMarkerDependentSegment
    {
        #region Properties
        ...
        {
            Rect rect = new Rect(this.X1 - (markerWidth / 2), this.Y1 - (markerHeight / 2), markerWidth, markerHeight);
            return rect;
        }
