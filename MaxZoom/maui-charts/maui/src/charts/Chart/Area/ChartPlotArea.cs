...
namespace Syncfusion.Maui.Charts
{
    internal class ChartPlotArea : AbsoluteLayout, IChartPlotArea
    {
        ...
        internal readonly AbsoluteLayout ItemLabelLayout;
        ...
        public ChartPlotArea()
        {
            ...
            ItemLabelLayout = new AbsoluteLayout();
            ...
            AbsoluteLayout.SetLayoutBounds(ItemLabelLayout, new Rect(0, 0, 1, 1));
            AbsoluteLayout.SetLayoutFlags(ItemLabelLayout, AbsoluteLayoutFlags.All);
        ...
        internal virtual void AddSeries(int index, object series)
        {
            ...
            if (chartSeries != null)
            {
                ...
                chartSeries.Parent = Chart as Element ?? null;
                ...
                ItemLabelLayout.Insert(index, labelView);
        ...
        internal virtual void RemoveSeries(int index, object series)
        {
            ...
            if (chartSeries != null)
            {
                ...
                ItemLabelLayout.Children.RemoveAt(index);
