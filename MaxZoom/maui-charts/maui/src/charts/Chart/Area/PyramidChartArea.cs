...
{
    internal class PyramidChartArea : AreaBase, IChartPlotArea
    {
        #region Fields
        ...
        internal readonly DataLabelLayout LabelTemplateView;
        ...
        public PyramidChartArea(IPyramidChartDependent chart)
        {
            ...
            LabelTemplateView = new DataLabelLayout(chart);
        ...
        public void UpdateLegendItem(LegendItem legendItem)
        {
            ...
            {
                var color = chartBase.LegendStyle.TextColor;
                legendItem.TextColor = color;
                legendItem.FontSize = (float)chartBase.LegendStyle.FontSize;
