...
namespace Syncfusion.Maui.Charts
{
    internal class CartesianPlotArea : ChartPlotArea
    {
        ...
        private readonly ChartPlotBandView chartPlotBandView;
        ...
        public CartesianPlotArea(CartesianChartArea area) : base()
        {
            ...
            chartPlotBandView = new ChartPlotBandView(area);
            ...
            AbsoluteLayout.SetLayoutBounds(chartPlotBandView, new Rect(0, 0, 1, 1));
            AbsoluteLayout.SetLayoutFlags(chartPlotBandView, AbsoluteLayoutFlags.All);
            Insert(0, GridLineLayout);
            Insert(1, chartPlotBandView);
            BatchCommit();
        }
        ...
        {
            chartPlotBandView.InvalidateDrawable();
        }
