...
namespace Syncfusion.Maui.Charts
{
    ...
    public class ChartLineStyle : Element , IThemeElement
    {
        ...
        /// </summary>        
        public static readonly BindableProperty StrokeProperty = BindableProperty.Create(nameof(Stroke), typeof(Brush), typeof(ChartLineStyle), null, BindingMode.Default, null, OnStrokeColorChanged, defaultValueCreator: StrokeDefaultValueCreator);
        ...
        static Brush StrokeDefaultValueCreator(BindableObject bindable)
        {
