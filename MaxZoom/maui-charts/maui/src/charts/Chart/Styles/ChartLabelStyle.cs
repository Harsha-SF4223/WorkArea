...
namespace Syncfusion.Maui.Charts
{
    ...
    public class ChartLabelStyle : Element, ITextElement , IThemeElement
    {
        ...
        /// </summary>        
        public static readonly BindableProperty TextColorProperty = BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(ChartLabelStyle), null, BindingMode.Default, null, OnTextColorChanged, null, defaultValueCreator: TextColorDefaultValueCreator);

        /// <summary>
        /// Identifies the <see cref="Background"/> bindable property.
        /// </summary>        
        public static readonly BindableProperty BackgroundProperty = BindableProperty.Create(nameof(Background), typeof(Brush), typeof(ChartLabelStyle), null, BindingMode.Default, null, OnBackgroundtColorChanged, null, defaultValueCreator: BackgroundDefaultValueCreator);
        ...
        /// </summary>        
        public static readonly BindableProperty FontSizeProperty = BindableProperty.Create(nameof(FontSize), typeof(double), typeof(ChartLabelStyle), 1.0, BindingMode.Default, null, null, null, null, FontSizeDefaultValueCreator);
        ...
        internal virtual Brush GetDefaulBackgroundColor()
        {
        ...
        static Color TextColorDefaultValueCreator(BindableObject bindable)
        {
            return ((ChartLabelStyle)bindable).GetDefaultTextColor();
        }   
        
        static Brush BackgroundDefaultValueCreator(BindableObject bindable)
        {
            return ((ChartLabelStyle)bindable).GetDefaulBackgroundColor();
        }
    ...
    internal class ChartLegendLabelStyle : ChartLabelStyle , IParentThemeElement
    {
        #region Constructor
        ...
        /// 
        /// </summary>
        public ChartLegendLabelStyle(ChartBase chart)
        {
        ...
        {
            if (this.Parent is ChartBase chart)
            {
                chart.UpdateLegendItems();
            }
        }

        private void SetLegendThemeValue(ChartBase chart)
        {
            if(chart is SfCartesianChart)
            {
                ThemeElement.InitializeThemeResources(this, "SfCartesianChartTheme");
                this.SetDynamicResource(TextColorProperty, "SfCartesianChartLegendTextColor");
                this.SetDynamicResource(FontSizeProperty, "SfCartesianChartLegendFontSize");
            }
            
            if(chart is SfCircularChart)
            {
                ThemeElement.InitializeThemeResources(this, "SfCircularChartTheme");
                this.SetDynamicResource(TextColorProperty, "SfCircularChartLegendTextColor");
                this.SetDynamicResource(FontSizeProperty, "SfCircularChartLegendFontSize");
            }
           
            if(chart is SfPyramidChart)
            {
                ThemeElement.InitializeThemeResources(this, "SfPyramidChartTheme");
                this.SetDynamicResource(TextColorProperty, "SfPyramidChartLegendTextColor");
                this.SetDynamicResource(FontSizeProperty, "SfPyramidChartLegendFontSize");
            }

            if(chart is SfFunnelChart)
            {
                ThemeElement.InitializeThemeResources(this, "SfFunnelChartTheme");
                this.SetDynamicResource(TextColorProperty, "SfFunnelChartLegendTextColor");
                this.SetDynamicResource(FontSizeProperty, "SfFunnelChartLegendFontSize");
            }

            if(chart is SfPolarChart)
            {
                ThemeElement.InitializeThemeResources(this, "SfCartesianChartTheme");
                this.SetDynamicResource(TextColorProperty, "SfPolarChartLegendTextColor");
                this.SetDynamicResource(FontSizeProperty, "SfPolarChartLegendFontSize");
            }
        }
