...
namespace Syncfusion.Maui.Charts
{
    ...
    /// </remarks>
    public class ChartPlotBandLabelStyle : ChartLabelStyle
    {
        ...
        /// </summary>
        public static readonly BindableProperty HorizontalTextAlignmentProperty = BindableProperty.Create(nameof(HorizontalTextAlignment), typeof(ChartLabelAlignment), typeof(ChartPlotBandLabelStyle), ChartLabelAlignment.Center, BindingMode.Default, null);

        /// <summary>
        /// Identifies the <see cref="VerticalTextAlignment"/> bindable property.
        /// </summary>
        public static readonly BindableProperty VerticalTextAlignmentProperty = BindableProperty.Create(nameof(VerticalTextAlignment), typeof(ChartLabelAlignment), typeof(ChartPlotBandLabelStyle), ChartLabelAlignment.Center, BindingMode.Default, null);

        /// <summary>
        /// Identifies the <see cref="Angle"/> bindable property.
        /// </summary>
        public static readonly BindableProperty AngleProperty = BindableProperty.Create(nameof(Angle), typeof(double), typeof(ChartPlotBandLabelStyle), 0.0d, BindingMode.Default, null);

        /// <summary>
        /// Identifies the <see cref="OffsetX"/> bindable property
        /// </summary>
        public static readonly BindableProperty OffsetXProperty = BindableProperty.Create(nameof(OffsetX), typeof(double), typeof(ChartPlotBandLabelStyle), 0.0d, BindingMode.Default, null);

        /// <summary>
        /// Identifies the <see cref="OffsetY"/> bindable property
        /// </summary>
        public static readonly BindableProperty OffsetYProperty = BindableProperty.Create(nameof(OffsetY), typeof(double), typeof(ChartPlotBandLabelStyle), 0.0d, BindingMode.Default, null);
        ...
        /// </summary>
        /// <value>This property takes the <see cref="ChartLabelAlignment"/> as its value.</value>
        ...
        /// <summary>
        /// Gets or sets a value to provide horizontal padding to the plot band text.
        /// </summary>
        /// <value>It accepts <see cref="double"/> values and the default value is 0.</value>
        /// # [MainPage.xaml](#tab/tabid-1)
        /// <code><![CDATA[
        ...
        /// <summary>
        /// Gets or sets a value to provide vertical padding to the plot band text.
        /// </summary>
        /// <value>It accepts <see cref="double"/> values and the default value is 0.</value>
        /// # [MainPage.xaml](#tab/tabid-1)
        /// <code><![CDATA[
