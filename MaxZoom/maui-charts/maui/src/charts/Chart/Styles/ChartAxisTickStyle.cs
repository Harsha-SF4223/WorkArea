...
namespace Syncfusion.Maui.Charts
{
    ...
    public class ChartAxisTickStyle : Element , IThemeElement
    {
        ...
        /// </summary>        
        public static readonly BindableProperty StrokeProperty = BindableProperty.Create(nameof(Stroke), typeof(Brush), typeof(ChartAxisTickStyle), new SolidColorBrush(Color.FromArgb("#CAC4D0")), BindingMode.Default, null, OnStrokeColorChanged);
        ...
        internal void InitializeDynamicResource(string tickStyle)
        {
            ...
            {
                this.SetDynamicResource(StrokeProperty, "SfCartesianChartMajorTickLineStroke");
            }

            if (tickStyle == "MinorTickStyle")
            {
                this.SetDynamicResource(StrokeProperty, "SfCartesianChartMinorTickLineStroke");
            }
        } 
