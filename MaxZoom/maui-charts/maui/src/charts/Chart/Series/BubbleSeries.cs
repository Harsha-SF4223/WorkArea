...
namespace Syncfusion.Maui.Charts
{
    ...
    public partial class BubbleSeries : XYDataSeries, IDrawCustomLegendIcon
    {
        ...
        /// </summary>
        /// <value>It accepts <see cref="String"/> and its default is Empty.</value>
        /// <example>
        /// # [Xaml](#tab/tabid-28)
        /// <code><![CDATA[
        ///     <chart:SfCartesianChart>
        ...
        internal override void GenerateSegments(SeriesView seriesView)
        {
            ...
            if (xValues == null || SizeValues.Count == 0)
            {
                return;
            }
        ...
        private void CreateSegment(int i, List<double> xValues, double bubbleSize, double segmentRadius)
        {
            ...
            if (segment == null || ActualData == null) return;
            segment.Series = this;
            segment.Index = i;
        ...
        internal override void OnDataSourceChanged(object oldValue, object newValue)
        {
            ...
            YValues.Clear();
            SizeValues.Clear();
            GeneratePoints(new[] { YBindingPath, SizeValuePath }, YValues, SizeValues);
        }
