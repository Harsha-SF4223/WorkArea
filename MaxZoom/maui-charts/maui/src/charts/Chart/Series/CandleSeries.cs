...
namespace Syncfusion.Maui.Charts
{
    ...
    public class CandleSeries : HiLoOpenCloseSeries
    {
        ...
        public static readonly BindableProperty StrokeProperty = BindableProperty.Create(nameof(Stroke),
            ...
            null,
            BindingMode.Default,
            null, OnStrokePropertyChanged);

        /// <summary>
        /// Identifies the <see cref="EnableSolidCandle"/> bindable property.
        /// </summary>
        public static readonly BindableProperty EnableSolidCandleProperty = BindableProperty.Create(nameof(EnableSolidCandle), 
            typeof(bool), 
            typeof(CandleSeries), 
            false, 
            BindingMode.Default, 
            null, OnSolidCandlePropertyChanged);
        ...
        {
            var series = bindable as CandleSeries;
        ...
        private static void OnSolidCandlePropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
