    ...
    public class PieSeries : CircularSeries, IDrawCustomLegendIcon
    {
        ...
        public static readonly BindableProperty ExplodeAllProperty =
            BindableProperty.Create(
                ...
                typeof(bool),
                typeof(PieSeries),
                false, BindingMode.Default, null,
                OnExplodeAllChanged);
        ...
        /// </summary>
        /// <value>It accepts bool, and the default is false.</value>
        /// <example>
        /// # [Xaml](#tab/tabid-1)
        /// <code><![CDATA[
        ///     <chart:SfCircularChart>
        ...
        private static void OnGroupToPropertiesChanged(BindableObject bindable, object oldValue, object newValue)
        {
        ...
        private static void OnExplodeAllChanged(BindableObject bindable, object oldValue, object newValue)
        {
            if (bindable is PieSeries pieSeries)
            {
                pieSeries.ScheduleUpdateChart();
