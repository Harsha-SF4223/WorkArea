...
namespace Syncfusion.Maui.Charts
{
    internal class SeriesView : SfDrawableView
    {
        ...
        readonly IChartPlotArea chartPlotArea;
        ...
        private void StartAnimation()
        {
            ...
            if (Series.SeriesAnimation != null)
            {
                ...
                Series.SeriesAnimation.Commit(this, animationName, 1, (uint)(Series.AnimationDuration * 1000), null, OnAnimationFinished, () => false);
            }
        }
