...
namespace Syncfusion.Maui.Charts
{
    ...
    /// 
    /// <para>The Legend contains list of data points in a chart series. The information provided in each legend item helps to identify the corresponding data point in the chart series. The Series <see cref="ChartSeries.XBindingPath"/> property value will be displayed in the associated legend item.</para>
    /// 
    ...
    public class SfPolarChart : ChartBase, ITapGestureListener, ITouchListener, IParentThemeElement
    {
        ...
        /// <summary>
        /// Gets the primary axes in the chart.
        /// </summary>
        ...
        /// </summary>
        /// <value>This property takes the list of <see cref="Brush"/>, and its default value is the predefined palette.</value>
        /// <example>
        /// # [Xaml](#tab/tabid-18)
        /// <code><![CDATA[
        ...
        public SfPolarChart()
        {
            ...
            chartArea = (PolarChartArea)LegendLayout.AreaBase;
        ...
        {
            get { return polarStartAngle; }
            set
            {
                polarStartAngle = value;
            }
        }

        private int polarStartAngle = 270;
        ...
        {
            var visibleSeries = (chartArea as PolarChartArea).VisibleSeries;
        ...
        private void OnTouchUp(IChart chart, long pointerId, Point point)
        {
        ...
        private void OnTouchDown(IChart chart, long pointerId, Point point)
        {
        ...
        private static void OnSeriesPropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            if (bindable is SfPolarChart chart)
            {
                chart.chartArea.Series = newValue as ChartPolarSeriesCollection;
            }
        }

        private static void OnPrimaryAxisChanged(BindableObject bindable, object oldValue, object newValue)
        {
            if (bindable is SfPolarChart chart)
            {
                ...
                {
                    axis.Parent = chart;
                    axis.PolarArea = chart.chartArea;
        ...
        private static void OnSecondaryAxisChanged(BindableObject bindable, object oldValue, object newValue)
        {
            if (bindable is SfPolarChart chart)
            {
                if (newValue is ChartAxis axis)
        ...
        private static void OnGridlineTypeChanged(BindableObject bindable, object oldValue, object newValue)
        {
            if (bindable is SfPolarChart chart)
            {
                chart.chartArea.GridLineLayout.InvalidateDrawable();
            }
        }
        ...
        private void ScheduleUpdateArea()
        {
            chartArea.ScheduleUpdate(true);
        }
