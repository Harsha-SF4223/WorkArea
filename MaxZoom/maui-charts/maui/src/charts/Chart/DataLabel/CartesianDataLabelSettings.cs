...
namespace Syncfusion.Maui.Charts 
{
    ...
    public class CartesianDataLabelSettings : ChartDataLabelSettings
    {
        ...
        {
            SizeF labelSize = xyDataSeries.LabelTemplate is null ? labelStyle.MeasureLabel(dataLabel.LabelContent != null ? dataLabel.LabelContent : string.Empty) : xyDataSeries.GetLabelTemplateSize(dataLabel);
        ...
        internal PointF CalculateDataLabelPoint(RangeSeriesBase series, RangeColumnSegment dataLabel, PointF labelPoint, ChartDataLabelStyle labelStyle, string valueType)
        {
            ...
            SizeF labelSize = series.LabelTemplate is null ? labelStyle.MeasureLabel(dataLabel.DataLabel[0] != null ? dataLabel.DataLabel[0] : string.Empty) : series.GetLabelTemplateSize(dataLabel, valueType);
            float padding = (float)labelStyle.LabelPadding;

            return GetLabelPositionForRangeSeries(series, dataLabel.Index, labelSize, labelPoint, padding, valueType);
        }

        //Get the label position for range area series.
        internal PointF CalculateDataLabelPoint(RangeSeriesBase series, ChartSegment dataLabel, PointF labelPoint, ChartDataLabelStyle labelStyle, string valueType)
        {
            ...
            SizeF labelSize = series.LabelTemplate is null ? labelStyle.MeasureLabel(dataLabel.LabelContent != null ? dataLabel.LabelContent : string.Empty) : series.GetLabelTemplateSize(dataLabel);
            float padding = (float)labelStyle.LabelPadding;
        ...
        private PointF GetLabelPositionForRangeSeries(RangeSeriesBase series, int index, SizeF labelSize, PointF labelPoint, float padding, string valueType)
        {
        ...
        private PointF GetLabelPositionForCandleSeries(FinancialSeriesBase candleSeries, int index, SizeF labelSize, PointF labelPoint, float padding, string valueType)
        {
        ...
        private void UpdateHighTypePosition(double highValue, double lowValue,ref float x,ref float y, SizeF labelSize, double padding, double borderWidth, FinancialSeriesBase candleSeries)
        {
        ...
        private void UpdateLowTypePosition(double highValue, double lowValue,ref float x,ref float y, SizeF labelSize, double padding, double borderWidth, FinancialSeriesBase candleSeries)
        {
            if (candleSeries.ChartArea != null && candleSeries.ChartArea.IsTransposed)
            {
                if (LabelPlacement == DataLabelPlacement.Inner)
        ...
        private void UpdateOpenTypePosition(double openValue, double closeValue,ref float x,ref float y, SizeF labelSize, double padding, double borderWidth, FinancialSeriesBase candleSeries)
        {
            if (candleSeries.ChartArea != null && candleSeries.ChartArea.IsTransposed)
            {
                if (LabelPlacement == DataLabelPlacement.Inner)
        ...
        private void UpdateCloseTypePosition(double openValue, double closeValue,ref float x,ref float y, SizeF labelSize, double padding, double borderWidth, FinancialSeriesBase candleSeries)
        {
            if (candleSeries.ChartArea != null && candleSeries.ChartArea.IsTransposed)
            {
                if (LabelPlacement == DataLabelPlacement.Inner)
