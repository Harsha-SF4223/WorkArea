...
namespace Syncfusion.Maui.Charts
{
    ...
    /// ***
    /// </remarks>
    public class SfFunnelChart : ChartBase, IPyramidChartDependent, IDrawCustomLegendIcon, ITapGestureListener, ITouchListener, IParentThemeElement
    {
        ...
        /// </summary>        
        public static readonly BindableProperty LabelTemplateProperty = BindableProperty.Create(nameof(LabelTemplate), typeof(DataTemplate), typeof(SfFunnelChart), null, BindingMode.Default, null, null);
       ...
       BindableProperty.Create(nameof(DataLabelSettings), typeof(FunnelDataLabelSettings), typeof(SfFunnelChart), null, BindingMode.Default, null, OnDataLabelSettingsChanged);
        ...
        private void InitiateDataLabels(FunnelSegment funnelSegment)
        {
