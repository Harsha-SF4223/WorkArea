...
namespace Syncfusion.Maui.Charts
{
    ...
    public class ChartLegend : BindableObject, ILegend
    {
        ...
        /// </summary>        
        public static readonly BindableProperty ToggleSeriesVisibilityProperty = BindableProperty.Create(nameof(ToggleSeriesVisibility), typeof(bool), typeof(ChartLegend), false, BindingMode.Default, null, OnToggleVisibilityChanged);
